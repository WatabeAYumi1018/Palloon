...
bool CollisionCalc::HitCheckMap(const tnl::Vector3& circle, const Object* box) {
	return 0;
}
...
//   
//    // 線分の始点と終点のベクトル
//    tnl::Vector3 line_vec = line.m_end - line.m_start;
//    // 線分の始点から円の中心までのベクトル
//    tnl::Vector3 circle_vec = circle.m_pos - line.m_start;
//
//    // 線分の長さの2乗
...
//    if (t >= 0 && t <= 1.0f) {
//        // 交点から円の中心までの距離を計算
//        tnl::Vector3 intersection_point = line.m_start + t * line_vec;
//        // 距離の2乗を計算
...
//    else {
//        // 線分の始点と円の中心の距離の2乗
//        tnl::Vector3 distance1 = line.m_start - circle.m_pos;
//        // 線分の終点と円の中心の距離の2乗
//        tnl::Vector3 distance2 = { line.m_end - circle.m_pos;
//        //円の半径の2乗
//        float radius_squared = m_radius * m_radius;
//        //それぞれの長さを計算
